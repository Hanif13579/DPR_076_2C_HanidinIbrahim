...
<p class="text-gray-600 mb-6">Berikut adalah rincian komponen gaji yang berlaku untuk anggota ini.</p>
...
<div class="mt-6">
    <a href="<?= base_url('/admin/penggajian') ?>" class="text-indigo-600 hover:underline">
